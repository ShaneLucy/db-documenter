...
public class ResultSetMapper {
    ...
    public PrimaryKey mapToPrimaryKey(final ResultSet resultSet) throws SQLException {
        ...
        final var primaryKey =  PrimaryKey.builder()
                .columnNames(columnNames).constraintName(resultSet.getString("constraint_name"))
                .build();
    ...
    public Table combineTableColumnsPrimaryAndForeignKeys(final Table table, final List<Column> columns, final PrimaryKey primaryKey, final List<ForeignKey> foreignKeys) {
        return Table.builder()
                .schema(table.schema())
                .name(table.name())
                .type(table.type())
